...
pub fn build_run_context(
    ...
    Ok(serde_json::json!({
        ...
        "revisions": {
            "bundle_sha256": revisions.bundle,
            "reference": {"document_sha256": revisions.reference},
            "evaluation_schema": {"document_sha256": revisions.evaluation_schema},
            "datasets": {"document_sha256": revisions.datasets_lock}
        },
        "config": {},
        "metadata": {}
    }))
