...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        description="Validate the strict four-document revision bundle."
    )
...
def main() -> int:
    ...
    if args.json:
        ...
        print(f"root: {root}")
        print(f"config_version: {bundle.config_version}")
        ...
        print(f"tokenizer: {reference.tokenizer_repo_id}@{reference.tokenizer_revision}")
