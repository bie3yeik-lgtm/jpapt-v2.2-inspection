...
def main() -> int:
    ...
    if args.rejection:
        ...
        validate_receiver_binding(load(args.rejection), args.receiver_repository, allowed, label="rejection")
        return 0
    ...
    if args.ack:
        ...
        validate_receiver_binding(receipt, args.receiver_repository, allowed, label="receipt")
    return 0
