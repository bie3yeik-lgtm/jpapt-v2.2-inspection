...
DirectML provider or the Windows DirectML route. The old workflow, schemas,
and historical artifacts remain readable for audit and migration only; they
are not an active route. A resolver or reviewer must reject a new
